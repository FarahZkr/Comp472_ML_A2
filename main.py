...
for index, row in dataset.iterrows():
    ...
    if similar_word != "Synonyms not found.":
        ...
        to_write += f"{random.choice(word2vec_model.index_to_key)},guess"
    to_write += "\n"
    write_to_file_1(to_write)
    to_write = ""
if total_guesses != 0:
    total = correct_labels / total_guesses
else:
    total = 1
analysis_file = f"{model_name},{vocab_size},{correct_labels},{total_guesses},{total}"
